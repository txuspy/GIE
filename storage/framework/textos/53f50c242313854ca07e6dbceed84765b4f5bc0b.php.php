	...
	<div>
		<div class="col-sm-6 ">
            <div class="form-group has-success">
                ...
                <?php echo Form::text('proyecto_eu', null, array('placeholder' => 'Proiektua','class' => 'form-control buscadorProyectos')); ?>
        ...
        <div class="col-sm-6 ">
            <div class="form-group">
                ...
                <?php echo Form::text('proyecto_es', null, array('placeholder' => 'Proyecto','class' => 'form-control buscadorProyectos')); ?>
