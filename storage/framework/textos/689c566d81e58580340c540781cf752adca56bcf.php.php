<?php $__env->startSection('content'); ?>
	<?php echo Breadcrumbs::render('ekintzakAurretik', $tipo); ?>
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="col-sm-12 margin-tb">
						...
						<div class="pull-right">
							<a class="btn btn-info" href="<?php echo e(route('ekintzakAurretik.indexAll', [ 'tipo'=> $tipo ])); ?>"><i class="fa fa-list" title="<?php echo e(__('Guztiak ikusi')); ?>"></i></a>
								&nbsp;
								&nbsp;
							<a class="btn btn-info" href='' mostrarOcultar" onClick="$('#seccionSearch').toggle();return false;"  data-nomDiv="seccionSearch"><i class="fa fa-search" title ="<?php echo e(__('Bilatu')); ?>" ></i></a>
								&nbsp;
								&nbsp;
							<a class="btn btn-success" href="<?php echo e(route('ekintzakAurretik.create', [ 'tipo'=> $tipo ] )); ?>"><i class="fa fa-plus" title ="<?php echo e(__('Berria sortu')); ?>"></i> </a>
						</div>
				...
				<?php echo $__env->make('ekintzakAurretik.search', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
				...
				<table class="table">
					...
					<tr>
						<td colspan="2">
							...
							?>
							<a href="<?php echo e(route('ekintzakAurretik.edit',$ekintza->id)); ?>"
...
<!---
						<td>
							<a href="<?php echo e(route('ekintzakAurretik.edit',$ekintza->id)); ?>"><?php echo $ekintza->$desc; ?></a>

						</td>
-->
						<td>
							<a class="btn btn-primary" href="<?php echo e(route('ekintzakAurretik.edit',$ekintza->id)); ?>"
							<?php if(Session::get('search')=='1'): ?>
								target="_blank"
							<?php endif; ?>
							>
							...
							<?php if( $ekintza->user_id == \Auth::user()->id ): ?>
								<?php echo Form::open(['method' => 'DELETE','route' => ['ekintzakAurretik.destroy', $ekintza->id, $ekintza->tipo],'style'=>'display:inline']); ?>
