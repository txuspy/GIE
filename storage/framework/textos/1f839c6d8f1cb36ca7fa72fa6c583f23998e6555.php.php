		...
		<div>
			<div class="col-xs-6 ">
		      	 <div class="form-group has-success">
		                ...
		                <?php echo Form::select('ekarpena', ['1' => __('Hitzaldi gonbidatua / Ponencia invitada'), '2' => __('Ahozkoaurkezpena / Comunicación oral'), '3' => __('Posterra / Poster') ], $congreso->ekarpena??'1' , ['class' => 'form-control chosen-type']); ?>
