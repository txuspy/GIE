<?php $__env->startSection('content'); ?>
	<?php echo Breadcrumbs::render('ekintzakGizartea', $tipo); ?>

			<div class="panel panel-default">
				<div class="panel-body">
					<div class="col-sm-12 margin-tb">
						<div class="pull-left">
							<?php if( $tipo == 'gizartea' ): ?>
								<h2><?php echo e(__('Gizarte-erantzukizuneko ekintzak')); ?></h2>
    						<?php else: ?>
    							<h2><?php echo e(__('Gizarte-erantzukizuneko ekintzak')); ?></h2>
							<?php endif; ?>
						</div>
						...
						<div class="pull-right">
							<a class="btn btn-info" href="<?php echo e(route('ekintzakGizartea.indexAll', [ 'tipo'=> $tipo ])); ?>"><i class="fa fa-list" title="<?php echo e(__('Guztiak ikusi')); ?>"></i></a>
								&nbsp;
								&nbsp;
							<a class="btn btn-info" href='' mostrarOcultar" onClick="$('#seccionSearch').toggle();return false;"  data-nomDiv="seccionSearch"><i class="fa fa-search" title ="<?php echo e(__('Bilatu')); ?>" ></i></a>
								&nbsp;
								&nbsp;
							<a class="btn btn-success" href="<?php echo e(route('ekintzakGizartea.create', [ 'tipo'=> $tipo ] )); ?>"><i class="fa fa-plus" title ="<?php echo e(__('Berria sortu')); ?>"></i> </a>
						</div>
				...
				<?php echo $__env->make('ekintzakGizartea.search', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
				...
				<table class="table">
					...
					<tr>
						<td colspan="2">
							...
							?>
							<a href="<?php echo e(route('ekintzakGizartea.edit',$ekintza->id)); ?>"
						...
						<!--<td>
							<a href="<?php echo e(route('ekintzakGizartea.edit',$ekintza->id)); ?>"><?php echo e($ekintza->$desc); ?></a>

						</td>-->

						<td>
							<a class="btn btn-primary" href="<?php echo e(route('ekintzakGizartea.edit',$ekintza->id)); ?>"
							<?php if(Session::get('search')=='1'): ?>
								target="_blank"
							<?php endif; ?>
							>
							...
							<?php if( $ekintza->user_id == \Auth::user()->id ): ?>
								<?php echo Form::open(['method' => 'DELETE','route' => ['ekintzakGizartea.destroy', $ekintza->id, $ekintza->tipo],'style'=>'display:inline']); ?>
