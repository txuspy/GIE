			...
			<div>
				<div class="col-sm-6 ">
		            <div class="form-group has-success">
		                ...
		                <?php echo Form::text('titulo_eu', null, array('placeholder' => 'Izenburua','class' => 'form-control buscadorPublicaciones')); ?>
		        ...
		        <div class="col-sm-6 ">
		            <div class="form-group">
		                ...
		                <?php echo Form::text('titulo_es', null, array('placeholder' => 'Titulo','class' => 'form-control buscadorPublicaciones')); ?>
