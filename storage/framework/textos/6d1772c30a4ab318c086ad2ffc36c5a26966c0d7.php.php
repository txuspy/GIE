	...
	<?php echo Breadcrumbs::render('equipamientoNuevo'); ?>
			...
			<div class="panel panel-default">
				...
				<table class="table">
					...
					<tr><td><?php echo e(__('Guztira:' )); ?> <?php echo e($data->total()); ?></td><td colspan='1' class='text-center'><?php echo e($data->links()); ?></td><td><?php echo e(__('Oraingo orria:' )); ?> <?php echo e($data->currentPage()); ?></td></tr>
				</table>
			</div>
