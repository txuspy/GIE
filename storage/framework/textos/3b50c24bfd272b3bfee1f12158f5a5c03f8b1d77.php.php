       ...
       <?php if($message = Session::get('success')): ?>
		...
		<div class="panel-body">
			...
			<div>
		        <div class="col-sm-6 ">
		            <div class="form-group">
		                <label><strong><?php echo e(__('Argitaletxea / revista')); ?> :</strong></label>
		                <?php echo Form::text('editorialRevisa', null, array('placeholder' => __('Editorial / revista') ,'class' => 'form-control')); ?>
