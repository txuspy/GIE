			...
			<div>
				<div class="col-sm-6 ">
		            <div class="form-group has-success">
		                ...
		                <?php echo Form::text('titulo_eu', null, array('placeholder' => 'Kurtsoa','class' => 'form-control buscadorFormaciones')); ?>
		        ...
		        <div class="col-sm-6 ">
		            <div class="form-group">
		                ...
		                <?php echo Form::text('titulo_es', null, array('placeholder' => 'Curso','class' => 'form-control buscadorFormaciones')); ?>
