			...
			<div>
				<div class="col-sm-6 ">
		            <div class="form-group has-success">
		                ...
		                <?php echo Form::text('titulo_eu', null, array('placeholder' => 'Proiektua','class' => 'form-control buscadorPostgrados')); ?>
		        ...
		        <div class="col-sm-6 ">
		            <div class="form-group">
		                <label><strong>Programa :</strong></label>
		                <?php echo Form::text('titulo_es', null, array('placeholder' => 'Proyecto','class' => 'form-control buscadorPostgrados')); ?>
		    ...
		    <div>
				<div class="col-sm-6 ">
		            <div class="form-group has-success">
		                ...
		                <?php echo Form::text('curso_eu', null, array('placeholder' => 'Kurtsoa','class' => 'form-control buscadorPostgrados')); ?>
		        ...
		        <div class="col-sm-6 ">
		            <div class="form-group">
		                ...
		                <?php echo Form::text('curso_es', null, array('placeholder' => 'Curso','class' => 'form-control buscadorPostgrados')); ?>
