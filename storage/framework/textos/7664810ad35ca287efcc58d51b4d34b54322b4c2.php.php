<?php $__env->startSection('content'); ?>
   <?php echo Breadcrumbs::render('ekintzakAurretikEdit', $ekintzakAurretik); ?>
       ...
       <?php if($message = Session::get('success')): ?>
		...
		<div class="panel-body">
			<div class="col-sm-12 margin-tb">
		        <div class="pull-left">
		        	<?php if( $ekintzakAurretik->tipo == 'aurretik' ): ?>
			...
			<div class="pull-right">
		            <a class="btn btn-primary" href="<?php echo e(route('ekintzakAurretik.index', ['tipo'  => $ekintzakAurretik->tipo ])); ?>"><i class="fa fa-reply" title="<?php echo e(__('Atzera')); ?>"></i></a>
		        </div>
		    </div>


			<?php echo Form::model($ekintzakAurretik, ['method' => 'PUT','route' => ['ekintzakAurretik.update', $ekintzakAurretik->id]]); ?>
		    ...
		    <div class="col-md-12 col-sm-12 col-md-12 text-center">
				<?php echo e(Form::hidden('tipo', $ekintzakAurretik->tipo)); ?>
