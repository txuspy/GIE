<?php $__env->startSection('content'); ?>
   <?php echo Breadcrumbs::render('ekintzakGizarteaEdit', $ekintzaGizartea); ?>
	   ...
	   <?php if($message = Session::get('success')): ?>
		...
		<div class="panel-body">
			<div class="col-sm-12 margin-tb">
				<div class="pull-left">
					<?php if( $ekintzaGizartea->tipo == 'gizartea' ): ?>
			...
			<div class="pull-right">
					<a class="btn btn-primary" href="<?php echo e(route('ekintzakGizartea.index', ['tipo'  => $ekintzaGizartea->tipo ])); ?>"><i class="fa fa-reply" title="<?php echo e(__('Atzera')); ?>"></i></a>
				</div>
			</div>


			<?php echo Form::model($ekintzaGizartea, ['method' => 'PUT','route' => ['ekintzakGizartea.update', $ekintzaGizartea->id]]); ?>
			...
			<div class="col-md-12 col-sm-12 col-md-12 text-center">
				<?php echo e(Form::hidden('tipo', $ekintzaGizartea->tipo)); ?>
