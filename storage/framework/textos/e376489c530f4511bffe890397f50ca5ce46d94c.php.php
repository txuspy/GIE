					...
					<?php if($data): ?>
						...
						<tr>
							<td>
								...
								<br> <i><small><?php echo e($equipamientoNuevo->usuario?$equipamientoNuevo->usuario->name:''); ?> <?php echo e($equipamientoNuevo->usuario?$equipamientoNuevo->usuario->lname:''); ?>

								<?php echo e(\App\Traits\Listados::fechasIndex($equipamientoNuevo)); ?>
