				...
				<table class="table">
					...
					<tr>
						<td>
							...
							<br> <i><small><?php echo e($grupoInv->usuario?$grupoInv->usuario->name:''); ?> <?php echo e($grupoInv->usuario?$grupoInv->usuario->lname:''); ?>  <?php echo e(\App\Traits\Listados::fechasIndex($grupoInv)); ?> </small></i>
						</td>
						<td>
						...
						<td><?php echo e($grupoInv->desde); ?> / <?php echo e($grupoInv->hasta); ?></td>
						<td>
							<a class="btn btn-primary" href="<?php echo e(route('grupoInvestigacion.edit',$grupoInv->id)); ?>"
							<?php if(Session::get('search')=='1'): ?>
								target="_blank"
							<?php endif; ?>
							><i class="fa fa-pencil" title="<?php echo e(__('Aldatu')); ?>"></i></a>
