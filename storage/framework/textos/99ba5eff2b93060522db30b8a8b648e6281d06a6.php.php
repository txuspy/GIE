...
<nav id="side-menu" aria-label="Menú específico" role="navigation" >
    ...
    <ul class="class-toggle-active level-1" role="menubar">
            ...
            <a href="">
             ...
             <ul class="sub-nav level-2">
                 ...
                 <li><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/formaciones/show/PDI/recibir')); ?>"><i class="fa fa-book" aria-hidden="true"></i> <?php echo e(__('IIPko Formazioa')); ?></a>
                       <ul>
                            <li class="level-3"><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/formaciones/show/PDI/recibir')); ?>"><i class="fa fa-address-book" aria-hidden="true"></i> <?php echo e(__('Jasotako formakuntza')); ?></a></li>
                  ...
                  <li><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/programasDeIntercambio/show/fuera')); ?>"><i class="fa fa-refresh" aria-hidden="true"></i> <?php echo e(__('Elkartrukeko programak')); ?></a>
                      <ul>
                            <li class="level-3"><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/programasDeIntercambio/show/internacional')); ?>"><i class="fa fa-share" aria-hidden="true"></i> <?php echo e(__('Programas de intercambio internacionales')); ?></a></li>
        ...
        <li  class="side-nav-item has-sub-nav class-toggle-active">
            <a href="">
                <span>  <?php echo e(mb_strtoupper(  __('AZPko Formazioa') )); ?></span>
            </a>
            <ul class="sub-nav level-2"> 
        ...
        <li  class="side-nav-item has-sub-nav class-toggle-active">
            <a href="">
                <span> <?php echo e(__('IKERKUNTZA-JARDUERA')); ?></span>
            </a>
            <ul class="sub-nav level-2">
