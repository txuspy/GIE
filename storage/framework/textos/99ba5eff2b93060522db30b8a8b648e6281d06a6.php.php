	...
	<ul class="class-toggle-active level-1" role="menubar">
		...
		<li class="side-nav-item">
			...
			<ul class="sub-nav level-2">
				...
				<li><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/infoTeknikoa')); ?>"><i class="fa fa-server" aria-hidden="true"></i> <?php echo e(__('Informazio teknikoa')); ?></a></li>
			</ul>
		</li>
		<br>
		@endrole
		...
		<li  class="side-nav-item has-sub-nav class-toggle-active">
			...
			<a href="">
				<span> <?php echo e(__('IRAKASKUNTZA-JARDUERAK')); ?></span>
			</a>
			<ul class="sub-nav level-2">
				@role('admin')
				
					<li><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/ekintzakAurretik/show/aurretik')); ?>">
						<i class="fa fa-user-o" aria-hidden="true"></i> <?php echo e(__('Unibertsitate aurreko ikasleei bideratutako ekintzak')); ?></a>
						
					</li>
					<li><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/ekintzak/show/laguntza')); ?>">
						<i class="fa fa-user-circle-o" aria-hidden="true"></i> <?php echo e(__('Eskolako ikasleei bideratutako ekintzak')); ?></a>
						<ul>
							<li class="level-3"><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/ekintzak/show/laguntza')); ?>"><i class="fa fa-handshake-o" aria-hidden="true"></i> <?php echo e(__('Bidelaguntza')); ?></a></li>
							<li class="level-3"><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/ekintzak/show/formakuntzaOsagarriak')); ?>"><i class="fa fa-address-card" aria-hidden="true"></i> <?php echo e(__('Formakuntza osagarriak')); ?></a></li>
						</ul>
					</li>
					@endrole
				<li><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/formaciones/show/PDI/recibir')); ?>"><i class="fa fa-book" aria-hidden="true"></i> <?php echo e(__('IRIen formakuntza-jarduerak')); ?></a>
					<ul>
						<li class="level-3"><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/formaciones/show/PDI/recibir')); ?>"><i class="fa fa-address-book" aria-hidden="true"></i> <?php echo e(__('Jasotakoa')); ?></a></li>
						<li class="level-3"><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/formaciones/show/PDI/dar')); ?>"><i class="fa fa-address-book-o" aria-hidden="true"></i> <?php echo e(__('Emandakoa')); ?></a></li>
					</ul>
				</li>
				...
				<li><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/visitas/show')); ?>">
					<i class="fa fa-car" aria-hidden="true"></i> <?php echo e(__('Instalazio bisitak')); ?></a>
				</li>
				-->
			...
			<!--	<li><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/postgrados/show/master')); ?>"><i class="fa fa-id-card" aria-hidden="true"></i> <?php echo e(__('Graduondoko programa')); ?></a>
					<ul>
						<li class="level-3"><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/postgrados/show/master')); ?>"><i class="fa fa-id-card-o" aria-hidden="true"></i> <?php echo e(__('Master-programa')); ?></a></li>
						   ...
						   <li class="level-3"><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/postgrados/show/doctorando')); ?>"><i class="fa fa-graduation-cap" aria-hidden="true"></i> <?php echo e(__('Doktoretza-programa')); ?></a>
						   </li>
		...
		<li  class="side-nav-item has-sub-nav class-toggle-active">
			<a href="">
				<span>  <?php echo e(mb_strtoupper(  __('AZP-EN FORMAKUNTZA-JARDUERAK') )); ?></span>
			</a>
			<ul class="sub-nav level-2">
				<li class="level-3"><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/formaciones/show/PAS/recibir')); ?>"><i class="fa fa-address-book" aria-hidden="true"></i> <?php echo e(__('Jasotakoa')); ?></a></li>
				<li class="level-3"><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/formaciones/show/PAS/dar')); ?>"><i class="fa fa-address-book-o" aria-hidden="true"></i> <?php echo e(__('Emandakoa')); ?></a></li>
			</ul>
		</li>
		<li  class="side-nav-item has-sub-nav class-toggle-active">
			<a href="">
				...
				<li><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/grupoInvestigacion')); ?>">
					...
					<li><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/proyectos/show/europa')); ?>">
						...
						<ul>
							...
							<li class="level-3"><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/proyectos/show/erakundeak')); ?>"><i class="fa fa-building-o" aria-hidden="true"></i> <?php echo e(__('Erakundeek diruz lagundutako ikerkuntza-proiektuak')); ?></a></li>
							<li class="level-3"><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/proyectos/show/empresa')); ?>"><i class="fa fa-industry" aria-hidden="true"></i> <?php echo e(__('Enpresek diruz lagundutako ikerkuntza-proiektuak')); ?></a></li>
						</ul>
					</li>
					...
					<li><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/publicaciones/show/libros')); ?>"><i class="fa fa-archive" aria-hidden="true"></i> <?php echo e(__('Argitalpenak')); ?></a>
						<ul>
							...
							<li class="level-3"><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/publicaciones/show/articulos')); ?>"><i class="fa fa-newspaper-o" aria-hidden="true"></i> <?php echo e(__('Artikuluak')); ?></a></li>
						</ul>
					</li>
			...
			@role('admin')
				<li  class="side-nav-item has-sub-nav class-toggle-active">
					<a href="">
						<span> <?php echo e(mb_strtoupper ( __('Gizarte-erantzukizuneko ekintzak') )); ?></span>
					</a>
					<ul class="sub-nav level-2">
							<li><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/ekintzakGizartea/show/gizartea')); ?>">
								<i class="fa fa-retweet" aria-hidden="true"></i> <?php echo e(__('Gizarte-erantzukizuneko ekintzak')); ?></a>
							</li>
					</ul>
				</li>
				<li  class="side-nav-item has-sub-nav class-toggle-active">
					<a href="">
						<span> <?php echo e(mb_strtoupper ( __('Eskolaren hedakuntza') )); ?></span>
					</a>
						<ul class="sub-nav level-2">
				
							<li class="level-3"><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/divulgacion/show/hedakuntza')); ?>"><i class="fa fa-television" aria-hidden="true"></i> <?php echo e(__('Ekitaldiak')); ?></a></li>
							<li class="level-3"><a href="<?php echo e(url(App\Lib\Functions::parseLang().'/divulgacion/show/prensa')); ?>"><i class="fa fa-newspaper-o" aria-hidden="true"></i> <?php echo e(__('Hedabideak')); ?></a></li>
						</ul>
					</ul>
				</li>
			@endrole
