	...
	<div class="row" >
        <div class="col-xs-4">
             <div class="form-group">
	            ...
	            <?php endif; ?>
	            <?php echo Form::select('lng', ['eu' => 'Euskara', 'es' => 'Castellano' ], Session::get('locale') , ['class' => 'form-control chosen-type']); ?>
		...
		<div class="col-xs-4 ">
            <div class="form-group">
                ...
                [
	                ...
	                '15' => __('Gizarte-erantzukizuneko ekintzak'),
	                '16' => __('Eskolaren hedakuntza'),
