				...
				<table class="table">
					...
					<tr>
						<td>
							...
							<br> <i><small><?php echo e($postgrado->usuario?$postgrado->usuario->name:''); ?> <?php echo e($postgrado->usuario?$postgrado->usuario->lname:''); ?> <?php echo e(\App\Traits\Listados::fechasIndex($postgrado)); ?></small></i>
						</td>
						<td>
