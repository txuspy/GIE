		...
		<div class="panel-body">
			<div class="col-sm-12 margin-tb">
				...
				<div class="pull-right">
					<a class="btn btn-primary" href="<?php echo e(route('ekintzakGizartea.index', ['tipo'  => $tipo ])); ?>"><i class="fa fa-reply" title="<?php echo e(__('Atzera')); ?>"></i></a>
				</div>
			</div>

	<?php echo Form::open(array('route' => 'ekintzakGizartea.store','method'=>'POST', 'class'=>'form' )); ?>
