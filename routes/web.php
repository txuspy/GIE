...
Route::group(['middleware' => ['auth']], function() {
	...
	Route::get('infoTeknikoa/', ['as' => 'home', 'uses' => 'HomeController@infoTeknikoa']);
	...
	Route::get('divulgacion/show/{tipo}', ['as' => 'divulgacion.index', 'uses' => 'DivulgacionController@index'] );
	Route::get('divulgacion/showAll/{tipo}', ['as' => 'divulgacion.indexAll', 'uses' => 'DivulgacionController@indexAll'] );
	Route::get('divulgacion/create/{tipo}', ['as' => 'divulgacion.create', 'uses' => 'DivulgacionController@create']  );
	Route::get('divulgacion/{id}/edit', ['as' => 'divulgacion.edit', 'uses' => 'DivulgacionController@edit']  );
	Route::put('divulgacion/{id}',  ['as' => 'divulgacion.update', 'uses' => 'DivulgacionController@update']  );
	Route::post('divulgacion/',  ['as' => 'divulgacion.store', 'uses' => 'DivulgacionController@store']  );
	Route::post('divulgacion/search',  ['as' => 'divulgacion.search', 'uses' => 'DivulgacionController@search']  );
	Route::delete('divulgacion/{id}/{tipo}', ['as' => 'divulgacion.destroy', 'uses' => 'DivulgacionController@destroy'] );

	Route::get('ekintzak/show/{tipo}', ['as' => 'ekintzak.index', 'uses' => 'EkintzakController@index'] );
	Route::get('ekintzak/showAll/{tipo}', ['as' => 'ekintzak.indexAll', 'uses' => 'EkintzakController@indexAll'] );
	Route::get('ekintzak/create/{tipo}', ['as' => 'ekintzak.create', 'uses' => 'EkintzakController@create']  );
	Route::get('ekintzak/{id}/edit', ['as' => 'ekintzak.edit', 'uses' => 'EkintzakController@edit']  );
	Route::put('ekintzak/{id}',  ['as' => 'ekintzak.update', 'uses' => 'EkintzakController@update']  );
	Route::post('ekintzak/',  ['as' => 'ekintzak.store', 'uses' => 'EkintzakController@store']  );
	Route::post('ekintzak/search',  ['as' => 'ekintzak.search', 'uses' => 'EkintzakController@search']  );
	Route::delete('ekintzak/{id}/{tipo}', ['as' => 'ekintzak.destroy', 'uses' => 'EkintzakController@destroy'] );


	Route::get('ekintzakAurretik/show/{tipo}', ['as' => 'ekintzakAurretik.index', 'uses' => 'EkintzakAurretikController@index'] );
	Route::get('ekintzakAurretik/showAll/{tipo}', ['as' => 'ekintzakAurretik.indexAll', 'uses' => 'EkintzakAurretikController@indexAll'] );
	Route::get('ekintzakAurretik/create/{tipo}', ['as' => 'ekintzakAurretik.create', 'uses' => 'EkintzakAurretikController@create']  );
	Route::get('ekintzakAurretik/{id}/edit', ['as' => 'ekintzakAurretik.edit', 'uses' => 'EkintzakAurretikController@edit']  );
	Route::put('ekintzakAurretik/{id}',  ['as' => 'ekintzakAurretik.update', 'uses' => 'EkintzakAurretikController@update']  );
	Route::post('ekintzakAurretik/',  ['as' => 'ekintzakAurretik.store', 'uses' => 'EkintzakAurretikController@store']  );
	Route::post('ekintzakAurretik/search',  ['as' => 'ekintzakAurretik.search', 'uses' => 'EkintzakAurretikController@search']  );
	Route::delete('ekintzakAurretik/{id}/{tipo}', ['as' => 'ekintzakAurretik.destroy', 'uses' => 'EkintzakAurretikController@destroy'] );


	Route::get('ekintzakGizartea/show/{tipo}', ['as' => 'ekintzakGizartea.index', 'uses' => 'EkintzakGizarteaController@index'] );
	Route::get('ekintzakGizartea/showAll/{tipo}', ['as' => 'ekintzakGizartea.indexAll', 'uses' => 'EkintzakGizarteaController@indexAll'] );
	Route::get('ekintzakGizartea/create/{tipo}', ['as' => 'ekintzakGizartea.create', 'uses' => 'EkintzakGizarteaController@create']  );
	Route::get('ekintzakGizartea/{id}/edit', ['as' => 'ekintzakGizartea.edit', 'uses' => 'EkintzakGizarteaController@edit']  );
	Route::put('ekintzakGizartea/{id}',  ['as' => 'ekintzakGizartea.update', 'uses' => 'EkintzakGizarteaController@update']  );
	Route::post('ekintzakGizartea/',  ['as' => 'ekintzakGizartea.store', 'uses' => 'EkintzakGizarteaController@store']  );
	Route::post('ekintzakGizartea/search',  ['as' => 'ekintzakGizartea.search', 'uses' => 'EkintzakGizarteaController@search']  );
	Route::delete('ekintzakGizartea/{id}/{tipo}', ['as' => 'ekintzakGizartea.destroy', 'uses' => 'EkintzakGizarteaController@destroy'] );
	...
	// LIMPIAR CACHE Y MIERDAS
	 Route::get ('limpiarGettext', 'HomeController@limpiarcache');
	Route::get('limpiar', ['as' => 'limpiar',  function () {
	    ...
	    <code>Existe ruta /limpiarGettext para ver si es problema de gettext y traducciones</code>
	    ';
	}]);
