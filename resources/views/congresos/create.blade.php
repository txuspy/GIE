            ...
            <div>
                <div class="col-sm-6 ">
                    <div class="form-group has-success">
                        ...
                        {!! Form::select('ekarpena', ['1' => __('Hitzaldi gonbidatua / Ponencia invitada'), '2' => __('Ahozkoaurkezpena / Comunicación oral'), '3' => __('Posterra / Poster') ], 1 , ['class' => 'form-control chosen-type'])  !!}
                    </div>
                </div>
                 <div class="col-sm-6 ">
                     <div class="form-group has-success">
