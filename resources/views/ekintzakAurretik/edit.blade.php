@extends('layouts.app')
@section('content')
   {!! Breadcrumbs::render('ekintzakAurretikEdit', $ekintzakAurretik) !!}
       ...
       @if ($message = Session::get('success'))
		...
		<div class="panel-body">
			<div class="col-sm-12 margin-tb">
		        <div class="pull-left">
		        	@if( $ekintzakAurretik->tipo == 'aurretik' )
			...
			<div class="pull-right">
		            <a class="btn btn-primary" href="{{ route('ekintzakAurretik.index', ['tipo'  => $ekintzakAurretik->tipo ]) }}"><i class="fa fa-reply" title="{{ __('Atzera') }}"></i></a>
		        </div>
		    </div>


			{!! Form::model($ekintzakAurretik, ['method' => 'PUT','route' => ['ekintzakAurretik.update', $ekintzakAurretik->id]]) !!}
			<div>
				<div class="col-sm-6 ">
		    ...
		    <div class="col-md-12 col-sm-12 col-md-12 text-center">
				{{ Form::hidden('tipo', $ekintzakAurretik->tipo) }}
