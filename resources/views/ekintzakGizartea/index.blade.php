...
@section('content')
	{!! Breadcrumbs::render('ekintzakGizartea', $tipo) !!}
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="col-sm-12 margin-tb">
						...
						<div class="pull-right">
							<a class="btn btn-info" href="{{ route('ekintzakGizartea.indexAll', [ 'tipo'=> $tipo ]) }}"><i class="fa fa-list" title="{{ __('Guztiak ikusi') }}"></i></a>
								&nbsp;
								&nbsp;
							<a class="btn btn-info" href='' mostrarOcultar" onClick="$('#seccionSearch').toggle();return false;"  data-nomDiv="seccionSearch"><i class="fa fa-search" title ="{{ __('Bilatu') }}" ></i></a>
								&nbsp;
								&nbsp;
							<a class="btn btn-success" href="{{ route('ekintzakGizartea.create', [ 'tipo'=> $tipo ] ) }}"><i class="fa fa-plus" title ="{{ __('Berria sortu') }}"></i> </a>
						</div>
				...
				@include('ekintzakGizartea.search')
				...
				<table class="table">
					...
					<tr>
						<td colspan="2">
							...
							?>
							<a href="{{ route('ekintzakGizartea.edit',$ekintza->id) }}"
						...
						<!--<td>
							<a href="{{ route('ekintzakGizartea.edit',$ekintza->id) }}">{{ $ekintza->$desc }}</a>

						</td>-->

						<td>
							<a class="btn btn-primary" href="{{ route('ekintzakGizartea.edit',$ekintza->id) }}"
							@if(Session::get('search')=='1')
								target="_blank"
							@endif
							>
							...
							@if( $ekintza->user_id == \Auth::user()->id )
								{!! Form::open(['method' => 'DELETE','route' => ['ekintzakGizartea.destroy', $ekintza->id, $ekintza->tipo],'style'=>'display:inline']) !!}
