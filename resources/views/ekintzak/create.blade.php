		...
		<div class="panel-body">
			<div class="col-sm-12 margin-tb">
				...
				<div class="pull-right">
					<a class="btn btn-primary" href="{{ route('ekintzak.index', ['tipo'  => $tipo ]) }}"><i class="fa fa-reply" title="{{ __('Atzera') }}"></i></a>
				</div>
			</div>

	{!! Form::open(array('route' => 'ekintzak.store','method'=>'POST', 'class'=>'form' )) !!}
	<div>
		<div class="col-sm-6 ">
